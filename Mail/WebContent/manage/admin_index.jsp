...
<%@ include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎使用胖羊商城后台管理系统</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    ...
                    <a href="admin_cateselect"><i class="icon-font">&#xe048;</i>查看分类</a>                   
                    <a href="admin_productselect"><i class="icon-font">&#xe01e;</i>查看产品</a>
                </div>
            </div>
        </div>
        <div class="result-wrap">
