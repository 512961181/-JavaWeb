    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/Mail/manage/admin_douserselect" method="get">
                        ...
                        <c:forEach var="u" items="${userlist}" >
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                ...
	                                <a class="link-del" href="javascript:Delete('你确定要删除用户【${u.USER_NAME }】吗？','/Mail/manage/admin_douserdel?id=${u.USER_ID}&cpage=${cpage}');">删除</a>
	                            	</c:if>
	                            </td>
	                        </tr>	               
						</c:forEach>
