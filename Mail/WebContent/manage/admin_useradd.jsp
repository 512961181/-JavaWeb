    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Mail/manage/admin_douseradd" method="post" id="myform" name="myform">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>确认密码：</th>
                                <td><input class="common-text" name="rePassWord" size="50" value="" type="text"></td>
                            </tr>
                            <tr>
                                <th>性别：</th>
                                <td>
                            ...
                            <tr>
                                <th>电子邮箱：</th>
                                <td>
                                	<input class="common-text" name="email" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>手机号码：</th>
                                <td>
                                	<input class="common-text" name="mobile" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>送货地址：</th>
                                <td>
                                	<input class="common-text" name="address" size="50" value="" type="text">
                                </td>
                            </tr>                                                                           
                            <tr>
                                <th></th>
