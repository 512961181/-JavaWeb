...
<div class="address">
    <div class="wrapper clearfix">
    	...
    	<a href="#" class="on">【胖羊】${p.PRODUCT_NAME }</a>
    </div>
</div><!-----------------------Detail------------------------------>
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            ...
            <div class="fr intro">
                <div class="title"><h4>【胖羊】${p.PRODUCT_NAME }</h4>
...
<script type="text/javascript">
	function shopAdd(id,url1){

		var count=document.getElementById("count").innerHTML;
		location.href='cartadd?id='+id+'&count='+count+'&url='+url1;
	}
</script>
    ...
    <div class="msgR fr" ><h4>为你推荐</h4>
        <div class="seeList"><a href="#">
            ...
            <a href="selectproductview?id="${cp.PRODUCT_ID }>
            	<dl>
            		<dt><img width="161px" src="images/product/${cp.PRODUCT_FILENAME }"></dt>
            		<dd>【胖羊】${cp.PRODUCT_NAME }</dd>
        ...
        <div class="imgCon bd">
            <div class="likeList clearfix">
                <div>
                	...
                	<a href="selectproductview?id=${lb.PRODUCT_ID }">
                    	<dl>
	                        <dt><img src="images/product/${lp.PRODUCT_FILENAME }"></dt>
		            		<dd>【胖羊】${lp.PRODUCT_NAME }</dd>
