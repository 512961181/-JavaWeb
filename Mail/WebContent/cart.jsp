        ...
        <c:forEach var="rs" items="${requestScope.shoplist }">
        	<div class="th">
	            <div class="pro clearfix">
	            	<label class="fl">
	            		<input type="checkbox" name="ck" value="${rs.cart_id }"/><span></span>
	            	</label>
	            	<a class="fl" href="selectproductview?=id"+${rs.cart_p_id }>
		                <dl class="clearfix">
		                    <dt class="fl"><img src="images/product/${rs.cart_p_filename }" width="120" height="120"></dt>
	            ...
	            <div class="number">
	            	<p class="num clearfix">
			            ...
			            <span datasrc="${rs.cart_id }" class="fl">${rs.cart_quantify}</span>
